...
import wrinkleTreatment from "../assets/rynkebehandling.jpeg";
import fillers from "../assets/fillersbehandling.jpeg";
    ...
    <>
      ...
      <Section className="p-4">
        <InfoCard
          title="Konsultasjon"
          description={[
            "Vi tilbyr e-konsultasjon. Ved booking av behandling vil du få tilsendt en SMS med skjema som du fyller ut hjemme. Skjema må fylles ut minimum 48 timer før behandling. Resten tar vi oss av! Skjema og konsultasjonen må alltid godkjennes av ansvarlig lege. Dette er inkludert i prisen.",
          ]}
          imageUrl={consult}
        />
      </Section>
