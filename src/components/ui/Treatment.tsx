...
export const Treatment = ({ imageUrl, title, description }: TreatmentProps) => {
  return (
    <article className="flex flex-col gap-4 p-4 lg:p-8 items-center md:flex-row md:gap-12 md:justify-center">
      <img className="rounded-md md:w-1/3" src={imageUrl} alt={title} />

      <div className="flex flex-col justify-between items-center md:items-start gap-8 md:w-1/3">
